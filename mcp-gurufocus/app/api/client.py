...
class GuruFocusClient:
    ...
    @classmethod
    async def get_stock_financials(cls, symbol: str, target_currency: str = "USD") -> Optional[Dict[str, Any]]:
        """
    ...
    @classmethod
    async def get_segments_data(cls, symbol: str, start_date: str) -> Optional[Dict[str, Any]]:
        """
    ...
    @classmethod
    async def get_news_headlines(cls, symbol: str) -> Optional[Union[Dict[str, Any], str, list]]:
        """
