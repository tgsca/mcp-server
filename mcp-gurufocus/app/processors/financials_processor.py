...
class FinancialsProcessor:
    ...
    def process_stock_financials(data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = {
            ...
            "jahresabschlüsse": {
                ...
                "income_statement": FinancialsProcessor._process_income_statement(
                    annuals
                ),
                "balance_sheet": FinancialsProcessor._process_balance_sheet(annuals),
                "cashflow_statement": FinancialsProcessor._process_cashflow_statement(
                    annuals
                ),
            },
            # "kennzahlen": {
    ...
    @staticmethod
    def _filter_data(
        section: Dict[str, List], exclude_keys: List[str] = None
    ) -> Dict[str, List]:
        """
