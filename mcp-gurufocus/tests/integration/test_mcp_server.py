...
class TestMCPServerIntegration:
    ...
    async def test_mcp_tool_integration_full_stack(self):
        ...
        with patch('app.api.client.GuruFocusClient.get_stock_summary', new_callable=AsyncMock) as mock_api:
    ...
    async def test_stock_financials_integration(self):
        ...
        with patch('app.api.client.GuruFocusClient.get_stock_financials', new_callable=AsyncMock) as mock_api:
            mock_api.return_value = {
                "financials": {
    ...
    async def test_analyst_estimates_integration(self):
        ...
        with patch('app.api.client.GuruFocusClient.get_analyst_estimates', new_callable=AsyncMock) as mock_api:
            mock_api.return_value = {
                "annual": {
                    "date": ["2024", "2025"],
    ...
    async def test_segments_data_integration(self):
        ...
        with patch('app.api.client.GuruFocusClient.get_segments_data', new_callable=AsyncMock) as mock_api:
            mock_api.return_value = {
                "business": {
                    "annual": [
                        {
    ...
    async def test_news_headlines_integration(self):
        ...
        with patch('app.api.client.GuruFocusClient.get_news_headlines', new_callable=AsyncMock) as mock_api:
            mock_api.return_value = {
                "news": [
                    {
                        "date": "2024-01-15", 
    ...
    async def test_concurrent_tool_execution(self):
        ...
        with patch('app.api.client.GuruFocusClient.get_stock_summary', new_callable=AsyncMock) as mock_summary, \
             patch('app.api.client.GuruFocusClient.get_stock_financials', new_callable=AsyncMock) as mock_financials, \
             patch('app.api.client.GuruFocusClient.get_analyst_estimates', new_callable=AsyncMock) as mock_estimates:
            
            # Mock responses
            mock_summary.return_value = {
                "summary": {"general": {"company": "Test Corp", "price": 100.0}, "ratio": {}}
            }
            mock_financials.return_value = {
                "financials": {"financial_template_parameters": {"REITs": "N"}, "annuals": {}}
            }
    ...
    async def test_default_parameters_integration(self):
        ...
        with patch('app.api.client.GuruFocusClient.get_segments_data', new_callable=AsyncMock) as mock_api:
            ...
            result = await get_concise_segments_data("AAPL")  # Should use default "201901"
